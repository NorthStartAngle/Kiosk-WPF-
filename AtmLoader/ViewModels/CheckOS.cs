...
namespace AtmLoader.ViewModels {
    public class CheckOS : Blank
    {
        ...
        private List<KeyValuePair<string, object>> _details = new List<KeyValuePair<string, object>>();
        public List<KeyValuePair<string, object>> Details
        {
            get => _details;

...
namespace kiosk_deployer.Pages
{
    /// <summary>
    ...
    public partial class startPage : Page
    {
        ...
        private void btnUserSelected(object sender, RoutedEventArgs e)
        {
            ...
            {
                if(dlg.FileName != null && _viewinfo?.SelectedUser != "")
                {
                    // HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon
                    if (writeToRegedit(Registry.LocalMachine, @"SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon","Shell", @"C:\Program Files\Notepad++\notepad++.exe"))
                    {
